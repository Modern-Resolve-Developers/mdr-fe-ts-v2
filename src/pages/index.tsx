...
import {
  workWithAccountSetup,
  workWithCoolDowns,
  workWithMigrationRouter,
} from "@/utils/secrets/secrets_migrate_route";
import {
  MigrationReceiver,
  RouteEntity,
  toBeMigrated,
            ...
            children={
              <div className="  flex justify-center p-10 ">
                <img
                  ...
                  className="w-[30rem] sm:w-[40rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 md:w-[85rem] md:-ml-4 lg:-ml-0"
                  width={2432}
                  height={1442}
                />
              </div>
