...
const DigitalMeet: React.FC = () => {
    ...
    const columns : any[] = [
        ...
        {
            field: 'roomName', headerName: 'Room name', width: 160, sortable: false
        },
        {
            field: 'roomUrl', headerName: 'Room URL', sortable: false, width: 200
        },
        {
            field: 'roomStatus', headerName: 'Room Status',
        ...
        {
            field: 'isPrivate', headerName: 'Room Type',
            sortable: false,
            width: 100,
            renderCell: (params: any) => {
        ...
        },
        {
            ...
            renderCell: (params: any) => {
                if(params.row.roomStatus == '2') {
                    ...
                    return (
                        <div style={{ padding: '2vh'}}>
                                <NormalButton variant="outlined" onClick={() => router.push(params.row.roomUrl)} size="small" children="JOIN" color="success" />
                            </div>
                    )
                }
            }
