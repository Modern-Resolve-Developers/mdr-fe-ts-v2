...
import { TaskInformationDetailsForm, TaskAssigneeDetailsForm, Completed } from './forms'
...
export const TaskFormAdditionalDetails = () => {
    ...
    return (
        <Container>
            <OnboardingStepper sx={{ mt: 3 }} activeStep={activeStep} steps={[
                'Task Information', 'Task Assignee', 'Completed'
            ]} />
            <Box mt={2} width="100%">
                <ActiveForm />
            </Box>
