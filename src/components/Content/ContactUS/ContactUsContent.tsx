...
const ContactUsContent = () => {
  ...
  return (
        <div className="mx-4">
          <div className="px-4 pt-8">
            <h2 className="cursor-pointer text-black-400">
              <a onClick={() => Router.push('/')}>
                <Typography><span aria-hidden="true">&larr;</span> Home</Typography>
              </a>
            </h2>
          </div>
          ...
          <div className="flex gap-6 py-1  mt-0  md:mt-[30px] flex-col md:flex-row md:py-20">
            <div className="container mx-auto mt-5">
                <div className="w-full md:w-3/5 m-3 p-2 md:p-4 pt-16">
                  <Typography variant='h5' sx={{
                    fontWeight: 'bold'
                  }} className="flex-none w-full md:w-[553px] h-[50px]  tracking-tight text-gray-900 text-3xl font-bold">
