    ...
    render() {
        return (
            <div className={styles.helloWorld}>
                ...
                <div>
                    <button className={styles.button} onClick={this.showScanner}>Video Decode</button>
                    <button className={styles.button} onClick={this.showImgDecode}>Image Decode</button>
                </div>
